...
<div class="boton_agr_pago_doc">
    <button type="button" onclick="limpiar()" class="btn btn-secondary btn-lg" id="New_doc" data-toggle="modal" data-target="#exampleModal" data-whatever=" @getbootstrap" style="background-color: #28d; margin-left: 82%; margin-top: 160px;">Agregar</button>
    </div>